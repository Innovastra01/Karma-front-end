        ...
        <Section>
            <div className={"row"}>
                <div className={"col"} id={"buysell1"}>
                    ...
                    <div className={"text"}>
                        <h2>Buy and sell virtual <span>Lands</span> and <span>Properties.</span></h2>
                    </div>
                </div>
                <div className={"col"} id={"buySell2"}>
                    <h2>Buy and Sell <span>Virtual Resources</span> and Businesses</h2>
                    <img src={ BuySell2 } alt={"Buy Sell 2"} />
                </div>
                <div className={"col"} id={"buySell3"}>
                    <img src={ BuySell3 } alt={"Buy Sell 3"} />
                </div>
                <h2> Earn <span>REEK</span>, a new kind of reality- backed health </h2>
            </div>
        </Section>
    );
}
